...
public class ViewWhiteBackGround extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0, 0, slideLeft ,mPoint.y
                , paint);
        canvas.drawRect(slideLeft, 0,slideRight,slideTop
                , paint);
        canvas.drawRect(slideLeft, slideBottom,slideRight,mPoint.y
                , paint);
        canvas.drawRect(slideRight, 0,mPoint.x,mPoint.y
                , paint);
    }
}
