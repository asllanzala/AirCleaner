package com.honeywell.hch.airtouchv3.framework.enrollment.activity;
...
public class EnrollBaseActivity extends BaseActivity {
    ...
    public void errorHandle(ResponseResult responseResult, String errorMsg) {
        ...
        if (responseResult == null || responseResult.getFlag() == AirTouchConstants.CHECK_MAC_OFFLINE) {
        ...
        if (responseResult.getResponseCode() == StatusCode.EXCEPTION) {
            MessageBox.createSimpleDialog(this, null,
                    HPlusApplication.getInstance().getApplicationContext().getString(R.string.no_network), null, quitEnroll);
            return;
        }
