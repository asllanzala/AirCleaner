...
import com.honeywell.hch.airtouchv3.lib.weather.initializers.initializers.AccelerationInitializer;
import com.honeywell.hch.airtouchv3.lib.weather.initializers.initializers.ParticleInitializer;
import com.honeywell.hch.airtouchv3.lib.weather.initializers.initializers.RotationInitiazer;
import com.honeywell.hch.airtouchv3.lib.weather.initializers.initializers.RotationSpeedInitializer;
import com.honeywell.hch.airtouchv3.lib.weather.initializers.initializers.ScaleInitializer;
import com.honeywell.hch.airtouchv3.lib.weather.initializers.initializers.SpeeddByComponentsInitializer;
import com.honeywell.hch.airtouchv3.lib.weather.initializers.initializers.SpeeddModuleAndRangeInitializer;
import com.honeywell.hch.airtouchv3.lib.weather.initializers.initializers.SpeeddRelatedSizeInitializer;
import com.honeywell.hch.airtouchv3.lib.weather.initializers.modifiers.AlphaModifier;
...
//	}
	...
	public ParticleSystem(Activity a, int maxParticles, int resouseId, long timeToLive,int viewId) {
		this(a, maxParticles, timeToLive, viewId);
...
//	}
	...
	public void startEmiting(int particlesPerSecond) {
		...
		mDrawingView = new ParticleField(HPlusApplication.getInstance().getApplicationContext());
	...
	private void recycleParticle(ArrayList<Particle> usedParticleList){
		try{
			if (usedParticleList != null && usedParticleList.size() > 0){
				int size = usedParticleList.size();
				for (int i = 0 ; i < size ;i++){
					Particle particle = usedParticleList.get(i);
					if (particle != null && particle.mImage != null && !particle.mImage.isRecycled())
