...
import com.honeywell.hch.airtouchv3.framework.enrollment.utils.PasswordUtil;
...
//                mPasswordEditText.getEditText().setTextColor(csl);
    ...
    private MessageBox.MyOnClick quitEnroll = new MessageBox.MyOnClick() {
        @Override
        public void onClick(View v) {
            UmengUtil.onEvent(EnrollWifiPasswordActivity.this,
                    UmengUtil.EventType.ENROLL_CANCEL.toString(), "page4");
