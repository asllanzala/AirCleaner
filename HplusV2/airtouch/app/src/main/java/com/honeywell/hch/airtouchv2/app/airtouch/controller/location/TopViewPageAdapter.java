...
public class TopViewPageAdapter extends PagerAdapter {
    private List<TopViewFragment> fragments;
    private final FragmentManager mFragmentManager;
    private FragmentTransaction mCurTransaction = null;
    private Fragment mCurrentPrimaryItem = null;

    public TopViewPageAdapter(FragmentManager fm, List<TopViewFragment> oneListFragments) {
    ...
    public void logoutClear(){
        ...
        if (fragments != null){
            for(int i = 0;i < fragments.size();i++){
                TopViewFragment fitem = fragments.get(i);
    ...
    public void removeFragmentItem(int postion){
        ...
        if (fragments != null && postion < fragments.size()){
            TopViewFragment fitem = fragments.get(postion);
                mCurTransaction.remove(fitem);
        }
    }
