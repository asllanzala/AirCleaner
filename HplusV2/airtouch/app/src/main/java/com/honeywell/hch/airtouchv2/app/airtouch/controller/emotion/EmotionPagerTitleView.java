...
import com.honeywell.hch.airtouchv2.framework.webservice.task.EmotionalBottleTask;
...
public class EmotionPagerTitleView extends RelativeLayout
{
    ...
    public void setEmotionPagerMainView(EmotionPagerMainView thisMainView)
    {
...
//        Animation titleAinmation = new Animation() {
//
//            @Override
...
//                RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams
//                        (smallTitleView.getLayoutParams());
//
//                params.width = oneTitleView.getWidth();
//                params.height = oneTitleView.getHeight();
//                params.addRule(RelativeLayout.ALIGN_PARENT_TOP, RelativeLayout.TRUE);
//                params.addRule(RelativeLayout.CENTER_HORIZONTAL, RelativeLayout.TRUE);
//                params.addRule(RelativeLayout.CENTER_IN_PARENT, RelativeLayout.TRUE);
//                params.topMargin = DensityUtil.dip2px(45);
//                smallTitleView.setLayoutParams(params);
//                textView.setTextSize(26);
//            }
//        };
//        smallTitleView.startAnimation(titleAinmation);
...
//        collectedTextView.setAlpha(ALPHA_40);

        //begin request from server ,bottle can not be clickable
    ...
    /**
     * set the title to the default status when the home cell is changed
     */
    public void setTitleShowDefaultStatus()
    {
        if (!bigYesterdayShown)
        {
            bigYesterdayShown = true;

//            initSmallBackground();
//            oneTitleText.setText(yesterdayText.getText());
            isBigFromSmall = true;
            ...
            requestIdForShare = AirTouchConstants.YESTERDAY_REQUEST;
        }
